...
const i18n = {
  ko: {
    ...
    "brief.toc.04.d": "필리핀·쿠알라탄중·칼리만탄·술라웨시·파푸아·DRC/잠비아",
  ...
  en: {
    ...
    "brief.toc.04.d": "Philippines, Kuala Tanjung, Kalimantan, Sulawesi, Papua, DRC/Zambia",
  ...
  id: {
    ...
    "brief.toc.04.d": "Filipina, Kuala Tanjung, Kalimantan, Sulawesi, Papua, DRC/Zambia",
  ...
  zh: {
    ...
    "brief.toc.04.t": "采购网络",
    "brief.toc.04.d": "菲律宾、瓜拉丹戎、加里曼丹、苏拉威西、巴布亚、刚果（金）/赞比亚",
