...
const i18n = {
  ko: {
    ...
    "prof.toc.06.t": "취급 품목",
    "prof.toc.06.d": "9품목 설명·대표 HS·공급 포인트",
    "prof.toc.07.t": "글로벌 소싱 네트워크",
    "prof.toc.07.d": "8개 산지의 역할",
    ...
    "brief.toc.04.d": "필리핀·쿠알라탄중·리아우·방카·벨리퉁·칼리만탄·술라웨시·파푸아·DRC/잠비아",
    ...
    "div.res.d": "구리 스크랩 · 구리 정광 · 알루미늄 잉곳 · 주석 괴 · 주석/니켈 슬래그 · 우드펠릿 · EN590 경유 · 카올린",
    ...
    "network.lead": "구리 정광은 필리핀, 알루미늄은 북수마트라 쿠알라탄중, 우드펠릿은 칼리만탄, 니켈은 술라웨시, 구리 스크랩은 파푸아와 DRC·잠비아에서 소싱합니다. EN590 경유는 울산 하역을 기준으로 문의합니다. 항만 거점은 다르에스살람과 자카르타입니다. 한국 본사는 VL M&amp;C입니다.",
    "network.map.alt": "필리핀 구리 정광, 쿠알라탄중 알루미늄, 칼리만탄 우드펠릿, 술라웨시 니켈, 파푸아·DRC/잠비아 구리, 울산 EN590과 다르에스살람·자카르타·서울 거점을 표시한 세계 지도",
    ...
    "network.kazakhstan": "쿠알라탄중",
    "network.kazakhstan.country": "인도네시아",
    "network.kazakhstan.desc": "북수마트라 INALUM 1차 알루미늄",
    "network.perth": "퍼스",
    "network.perth.country": "호주",
    "network.perth.desc": "서호주",
    ...
    "spec.origin": "산지",
    "spec.term": "조건",
    "p.alu.badge.metal": "1차 잉곳",
    "p.alu.badge.grade": "H2102",
    "p.alu.badge.assay": "S1-B",
    "p.alu.badge.flow": "G1",
    "p.alu.spec.use.v": "쿠알라탄중 · INALUM",
    "p.alu.spec.prio.v": "비합금 잉곳 · 22.7 kg",
    "p.tin.badge.metal": "주석 슬래그",
    "p.tin.badge.form": "제련 부산물",
    "p.tin.badge.assay": "함량 기준",
    "p.tin.badge.use": "유가금속 회수",
    "p.tin.spec.origin.v": "방카",
    "p.tin.spec.form.v": "슬래그 · 회수 원료",
    "p.sni.badge.metal": "주석 괴",
    "p.sni.badge.form": "금속 잉곳",
    "p.sni.badge.a": "제조 표준",
    "p.sni.badge.b": "방카·리아우",
    "p.sni.spec.form.v": "잉곳",
    "p.sni.spec.cert.v": "로트별 밀시트",
    ...
    "p.conc.2": "필리핀",
    "p.alu.t": "알루미늄 잉곳",
    "p.alu.d": "북수마트라 쿠알라탄중 INALUM의 1차 비합금 알루미늄 잉곳입니다. 재용해 후 자동차 부품·건축재·압출 소재로 씁니다.",
    "p.alu.1": "S1-A · S1-B · S2 · G1",
    "p.alu.2": "99.92 · 99.90 · 99.85 · 99.70%",
    "p.tin.t": "주석 슬래그",
    "p.tin.d": "주석 제련 과정에서 발생하는 슬래그를 유통합니다. 주석 및 유가금속 회수 원료로 활용됩니다.",
    "p.tin.1": "Sn 함량 기준 소싱",
    "p.tin.2": "회수·제련 원료 공급",
    "p.sni.t": "주석 괴",
    "p.sni.d": "제련을 마친 인도네시아산 주석 괴를 공급합니다. 주석 원광·슬래그와 다른 금속 잉곳입니다.",
    "p.sni.1": "Sn 99.85% · 99.90%",
    "p.sni.2": "방카 · 리아우 제도",
    "p.nick.t": "니켈 슬래그",
    ...
    "brief.intro": "구리 스크랩, 구리 정광, 알루미늄 잉곳, 주석 괴, 주석·니켈 슬래그, 우드펠릿, EN590 경유, 카올린을 필리핀·인도네시아·DRC·잠비아에서 소싱합니다. EN590은 한국 하역을 울산 기준으로 문의합니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 산지",
    "brief.s3": "인천 · 서울",
    "brief.s4": "시험 선적 후 확대",
    ...
    "mfr.range.t": "취급 범위",
    "mfr.range.res.t": "9개 품목",
    "mfr.range.res.p": "구리 스크랩 · 구리 정광 · 알루미늄 잉곳 · 주석 괴 · 주석/니켈 슬래그 · 우드펠릿 · EN590 경유 · 카올린",
    "mfr.how.t": "협업 순서",
    "mfr.how.1t": "사양 확정",
    ...
    "footer.contact": "연락처",
    "footer.top": "맨 위로",
    "strip.met.p": "구리 스크랩 · 구리 정광 · 알루미늄 잉곳 · 주석 괴 · 주석·니켈 슬래그",
    "strip.ene.p": "산업용 우드펠릿 · EN590 경유",
    "strip.min.p": "카올린 · 고령토",
    "panel.met.lead": "구리 스크랩·정광, 알루미늄 잉곳, 주석 괴, 주석·니켈 슬래그. 등급과 성분 기준으로 맞춥니다.",
  ...
  en: {
    ...
    "prof.toc.06.d": "Nine items with descriptions, HS codes and supply points",
    "prof.toc.07.t": "Global sourcing network",
    "prof.toc.07.d": "The role of each of the eight origins",
    ...
    "brief.toc.04.d": "Philippines, Kuala Tanjung, Riau, Bangka, Belitung, Kalimantan, Sulawesi, Papua, DRC/Zambia",
    ...
    "org.met.2": "Aluminum ingot · tin ingot",
    ...
    "div.res.d": "Copper scrap · Copper concentrate · Aluminum ingot · Tin ingot · Tin/Nickel slag · Wood pellets · EN590 diesel · Kaolin",
    "products.eyebrow": "Cargo",
    ...
    "network.lead": "Copper concentrate from the Philippines; aluminum from Kuala Tanjung, North Sumatra; wood pellets from Kalimantan; nickel from Sulawesi; copper scrap from Papua and DRC/Zambia. EN590 diesel is inquired against Ulsan discharge. Port hubs are Dar es Salaam and Jakarta. VL M&amp;C handles sourcing and delivery.",
    "network.map.alt": "World map showing copper concentrate in the Philippines, aluminum at Kuala Tanjung, wood pellets in Kalimantan, nickel in Sulawesi, copper in Papua and DRC/Zambia, EN590 at Ulsan, plus hubs in Dar es Salaam, Jakarta, and Seoul",
    ...
    "network.tag.aluminumHub": "Australia",
    ...
    "network.kazakhstan": "Kuala Tanjung",
    "network.kazakhstan.country": "Indonesia",
    "network.kazakhstan.desc": "INALUM primary aluminum, North Sumatra",
    "network.perth": "Perth",
    "network.perth.country": "Australia",
    "network.perth.desc": "Western Australia",
    ...
    "spec.origin": "Origin",
    "spec.term": "Terms",
    "p.alu.badge.metal": "Primary ingot",
    "p.alu.badge.grade": "H2102",
    "p.alu.badge.assay": "S1-B",
    "p.alu.badge.flow": "G1",
    "p.alu.spec.use.v": "Kuala Tanjung · INALUM",
    "p.alu.spec.prio.v": "Unalloyed ingot · 22.7 kg",
    "p.tin.badge.metal": "Tin slag",
    "p.tin.badge.form": "Smelt by-product",
    "p.tin.badge.assay": "Assay basis",
    "p.tin.badge.use": "Metal recovery",
    "p.tin.spec.origin.v": "Bangka",
    "p.tin.spec.form.v": "Slag · recovery feed",
    "p.sni.badge.metal": "Tin ingot",
    "p.sni.badge.form": "Metal ingot",
    "p.sni.badge.a": "Manufacturing grade",
    "p.sni.badge.b": "Bangka · Riau",
    "p.sni.spec.form.v": "Ingot",
    "p.sni.spec.cert.v": "Mill certificate per lot",
    ...
    "p.alu.d": "Primary unalloyed aluminum ingot from INALUM at Kuala Tanjung, North Sumatra. Remelted for auto parts, construction materials, and extrusion feedstock.",
    "p.alu.1": "S1-A · S1-B · S2 · G1",
    "p.alu.2": "99.92 · 99.90 · 99.85 · 99.70%",
    "p.tin.t": "Tin slag",
    ...
    "p.sni.t": "Tin ingot",
    "p.sni.d": "We supply refined Indonesian tin ingot, a metal ingot distinct from tin ore and tin slag.",
    "p.sni.1": "Sn 99.85% · 99.90%",
    "p.sni.2": "Bangka · Riau Islands",
    ...
    "brief.intro": "We source copper scrap, copper concentrate, aluminum ingot, tin ingot, tin and nickel slag, wood pellets, EN590 diesel, and kaolin from the Philippines, Indonesia, the DRC, and Zambia. EN590 is inquired against Ulsan discharge in Korea. Price and stock follow the offer and inspection at inquiry.",
    ...
    "mfr.range.res.t": "Nine items",
    "mfr.range.res.p": "Copper scrap · Copper concentrate · Aluminium ingot · Tin ingot · Tin / nickel slag · Wood pellets · EN590 diesel · Kaolin",
    ...
    "strip.met.p": "Copper scrap · copper concentrate · aluminum ingot · tin ingot · tin and nickel slag",
    "strip.ene.p": "Industrial wood pellets · EN590 diesel",
    "strip.min.p": "Kaolin · china clay",
    "panel.met.lead": "Copper scrap and concentrate, aluminum ingot, tin ingot, and tin and nickel slag, matched on grade and assay.",
  ...
  id: {
    ...
    "prof.toc.06.d": "Sembilan produk beserta uraian, kode HS, dan poin pasokan",
    "prof.toc.07.t": "Jaringan pengadaan global",
    "prof.toc.07.d": "Peran masing-masing dari delapan asal",
    ...
    "brief.toc.04.d": "Filipina, Kuala Tanjung, Riau, Bangka, Belitung, Kalimantan, Sulawesi, Papua, DRC/Zambia",
    ...
    "org.met.2": "Ingot aluminium · timah batangan",
    ...
    "div.res.d": "Skrap tembaga · Konsentrat tembaga · Ingot aluminium · Timah batangan · Terak timah/nikel · Pelet kayu · Solar EN590 · Kaolin",
    ...
    "network.lead": "Konsentrat tembaga dari Filipina; aluminium dari Kuala Tanjung, Sumatera Utara; pelet kayu dari Kalimantan; nikel dari Sulawesi; skrap tembaga dari Papua serta DRC/Zambia. Solar EN590 ditanyakan dengan bongkar Ulsan. Hub pelabuhan di Dar es Salaam dan Jakarta. VL M&amp;C menangani pengadaan dan pengiriman.",
    "network.map.alt": "Peta dunia yang menampilkan konsentrat tembaga di Filipina, aluminium di Kuala Tanjung, pelet kayu di Kalimantan, nikel di Sulawesi, tembaga di Papua dan DRC/Zambia, EN590 di Ulsan, serta hub di Dar es Salaam, Jakarta, dan Seoul",
    ...
    "network.kazakhstan": "Kuala Tanjung",
    "network.kazakhstan.country": "Indonesia",
    "network.kazakhstan.desc": "Aluminium primer INALUM, Sumatera Utara",
    "network.perth": "Perth",
    "network.perth.country": "Australia",
    "network.perth.desc": "Australia Barat",
    "network.kalimantan": "Kalimantan",
    "network.kalimantan.country": "Indonesia",
    ...
    "spec.origin": "Asal",
    "spec.term": "Syarat",
    "p.alu.badge.metal": "Ingot primer",
    "p.alu.badge.grade": "H2102",
    "p.alu.badge.assay": "S1-B",
    "p.alu.badge.flow": "G1",
    "p.alu.spec.use.v": "Kuala Tanjung · INALUM",
    "p.alu.spec.prio.v": "Ingot tanpa paduan · 22,7 kg",
    ...
    "p.sni.badge.metal": "Timah batangan",
    "p.sni.badge.form": "Ingot logam",
    "p.sni.badge.a": "Mutu manufaktur",
    "p.sni.badge.b": "Bangka · Riau",
    "p.sni.spec.form.v": "Ingot",
    "p.sni.spec.cert.v": "Sertifikat lot",
    ...
    "p.alu.d": "Ingot aluminium primer tanpa paduan dari INALUM di Kuala Tanjung, Sumatera Utara. Dilebur ulang untuk komponen otomotif, bahan bangunan, dan bahan ekstrusi.",
    "p.alu.1": "S1-A · S1-B · S2 · G1",
    "p.alu.2": "99,92 · 99,90 · 99,85 · 99,70%",
    "p.tin.t": "Terak timah",
    ...
    "p.sni.t": "Timah batangan",
    "p.sni.d": "Kami memasok timah batangan olahan dari Indonesia, ingot logam yang terpisah dari bijih timah dan terak timah.",
    "p.sni.1": "Sn 99,85% · 99,90%",
    "p.sni.2": "Bangka · Kepulauan Riau",
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, konsentrat tembaga, ingot aluminium, timah batangan, terak timah dan nikel, pelet kayu, solar EN590, dan kaolin dari Filipina, Indonesia, DRC, dan Zambia. EN590 ditanyakan dengan bongkar Ulsan di Korea. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
    ...
    "mfr.range.res.t": "Sembilan produk",
    "mfr.range.res.p": "Skrap tembaga · konsentrat tembaga · ingot aluminium · timah batangan · terak timah/nikel · pelet kayu · solar EN590 · kaolin",
    ...
    "strip.met.p": "Skrap tembaga · konsentrat tembaga · ingot aluminium · timah batangan · terak timah dan nikel",
    "strip.ene.p": "Pelet kayu industri · solar EN590",
    "strip.min.p": "Kaolin · tanah liat putih",
    "panel.met.lead": "Skrap dan konsentrat tembaga, ingot aluminium, timah batangan, serta terak timah dan nikel, disesuaikan dengan grade dan kadar.",
  ...
  zh: {
    ...
    "prof.toc.06.t": "产品范围",
    "prof.toc.06.d": "九类品项，含描述、HS 编码与供应点",
    "prof.toc.07.t": "全球采购网络",
    "prof.toc.07.d": "八大产地各自的角色",
    "prof.toc.08.t": "工作流程",
    ...
    "brief.toc.04.t": "采购网络",
    "brief.toc.04.d": "菲律宾、瓜拉丹戎、廖内、邦加、勿里洞、加里曼丹、苏拉威西、巴布亚、刚果（金）/赞比亚",
    ...
    "div.res.d": "铜废料 · 铜精矿 · 铝锭 · 锡锭 · 锡/镍渣 · 木颗粒 · EN590 柴油 · 高岭土",
    "products.eyebrow": "货物",
    "products.title": "供应品项",
    "products.lead": "有色金属、能源、工业矿物三大品类。请在此查看图片与核心规格，目录于询价后发送。",
    "network.eyebrow": "航线图",
    "network.title": "探寻新产地的航线图",
    "network.lead": "铜精矿来自菲律宾；铝来自北苏门答腊瓜拉丹戎；木颗粒来自加里曼丹；镍来自苏拉威西；铜废料来自巴布亚与刚果（金）/赞比亚。EN590 柴油按蔚山卸货询价。港口枢纽为达累斯萨拉姆与雅加达。VL M&amp;C 负责采购与交付。",
    "network.map.alt": "世界地图标注：菲律宾铜精矿、瓜拉丹戎的铝、加里曼丹木颗粒、苏拉威西镍、巴布亚与刚果（金）/赞比亚铜、蔚山 EN590，以及达累斯萨拉姆、雅加达与首尔等枢纽",
    ...
    "network.kazakhstan": "瓜拉丹戎",
    "network.kazakhstan.country": "印度尼西亚",
    "network.kazakhstan.desc": "北苏门答腊 INALUM 原生铝",
    "network.perth": "珀斯",
    "network.perth.country": "澳大利亚",
    "network.perth.desc": "西澳大利亚",
    ...
    "spec.origin": "产地",
    "spec.term": "条件",
    "p.alu.badge.metal": "原生锭",
    "p.alu.badge.grade": "H2102",
    "p.alu.badge.assay": "S1-B",
    "p.alu.badge.flow": "G1",
    "p.alu.spec.use.v": "瓜拉丹戎 · INALUM",
    "p.alu.spec.prio.v": "非合金锭 · 22.7 kg",
    "p.tin.badge.metal": "锡渣",
    "p.tin.badge.form": "冶炼副产品",
    "p.tin.badge.assay": "化验基准",
    "p.tin.badge.use": "金属回收",
    "p.tin.spec.origin.v": "邦加",
    "p.tin.spec.form.v": "渣料 · 回收原料",
    "p.sni.badge.metal": "锡锭",
    "p.sni.badge.form": "金属锭",
    "p.sni.badge.a": "制造标准",
    "p.sni.badge.b": "邦加·廖内",
    "p.sni.spec.form.v": "锭",
    "p.sni.spec.cert.v": "逐批质保书",
    ...
    "p.conc.2": "菲律宾",
    "p.alu.t": "铝锭",
    "p.alu.d": "北苏门答腊瓜拉丹戎 INALUM 的原生非合金铝锭。重熔后用于汽车零件、建材与挤压原料。",
    "p.alu.1": "S1-A · S1-B · S2 · G1",
    "p.alu.2": "99.92 · 99.90 · 99.85 · 99.70%",
    "p.tin.t": "锡渣",
    ...
    "p.tin.2": "回收与精炼原料",
    "p.sni.t": "锡锭",
    "p.sni.d": "供应印尼精炼锡锭。这是金属锭，与锡矿和锡渣分开。",
    "p.sni.1": "Sn 99.85% · 99.90%",
    "p.sni.2": "邦加 · 廖内群岛",
    "p.nick.t": "镍渣",
    ...
    "brief.intro": "我们从菲律宾、印尼、刚果（金）与赞比亚采购铜废料、铜精矿、铝锭、锡锭、锡渣与镍渣、木颗粒、EN590 柴油及高岭土。EN590 按韩国蔚山卸货询价。价格与库存以询价时的报价与检验为准。",
    "brief.s1": "经营品项",
    "brief.s2": "资源产地",
    "brief.s3": "Incheon · Seoul",
    "brief.s4": "试运后扩量",
    ...
    "mfr.range.t": "采购范围",
    "mfr.range.res.t": "九类产品",
    "mfr.range.res.p": "铜废料 · 铜精矿 · 铝锭 · 锡锭 · 锡/镍渣 · 木颗粒 · EN590 柴油 · 高岭土",
    "mfr.how.t": "合作方式",
    "mfr.how.1t": "锁定规格",
    ...
    "footer.top": "返回顶部",
    "lang.zh": "中文",
    "strip.met.p": "铜废料 · 铜精矿 · 铝锭 · 锡锭 · 锡渣与镍渣",
    "strip.ene.p": "工业木颗粒 · EN590 柴油",
    "strip.min.p": "高岭土",
    "panel.met.lead": "铜废料与铜精矿、铝锭、锡锭、锡渣与镍渣，按等级与成分匹配。",
