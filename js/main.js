...
const i18n = {
  ko: {
    ...
    "brief.intro": "구리 스크랩, 구리 정광, 알루미늄 잉곳, 주석 괴, 주석·니켈 슬래그, 우드펠릿, EN590 경유, 카올린을 필리핀·카자흐스탄·호주·인도네시아·DRC·잠비아에서 소싱합니다. EN590은 한국 하역을 울산 기준으로 문의합니다. 가격·재고는 문의 시점의 오퍼와 검사 결과에 따릅니다.",
    "brief.s1": "취급 품목",
    "brief.s2": "자원 산지",
    "brief.s3": "인천 · 서울",
    "brief.s4": "시험 선적 후 확대",
  ...
  id: {
    ...
    "brief.intro": "Kami mengadakan skrap tembaga, konsentrat tembaga, ingot aluminium, timah batangan, terak timah dan nikel, pelet kayu, solar EN590, dan kaolin dari Filipina, Kazakhstan, Australia, Indonesia, DRC, dan Zambia. EN590 ditanyakan dengan bongkar Ulsan di Korea. Harga dan stok mengikuti penawaran serta inspeksi pada saat pertanyaan.",
  ...
  zh: {
    ...
    "brief.intro": "我们从菲律宾、哈萨克斯坦、澳大利亚、印尼、刚果（金）与赞比亚采购铜废料、铜精矿、铝锭、锡锭、锡渣与镍渣、木颗粒、EN590 柴油及高岭土。EN590 按韩国蔚山卸货询价。价格与库存以询价时的报价与检验为准。",
    "brief.s1": "经营品项",
    "brief.s2": "资源产地",
    "brief.s3": "Incheon · Seoul",
    "brief.s4": "试运后扩量",
